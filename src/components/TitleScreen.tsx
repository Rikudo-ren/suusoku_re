...
import { loadPlayerName, savePlayerName } from "../lib/ranking";
          ...
          <span className="flex items-center gap-2">
            {editingName ? (
              <span className="flex items-center gap-1.5">
                ...
                />
                <button onClick={commitName} className="clip-chip bg-cyan-400/80 px-2 py-1 font-mono2 text-[9px] font-black text-black">
                  SAVE
                </button>
              </span>
            ) : (
