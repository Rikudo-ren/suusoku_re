...
export default function TitleScreen({ onStart, best, audioReady, lightweight, onEnableAudio, onRanking }: Props) {
    ...
    <div className="relative h-full w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full w-full flex-col items-center justify-center px-5 py-5">
        ...
        <button
          ...
          className="clip-btn mt-3 border border-yellow-400/40 bg-yellow-500/10 px-8 py-2.5 font-display text-sm font-black tracking-[0.3em] text-yellow-200 transition-colors hover:bg-yellow-500/20"
        >
          RANKING
        </button>
